        ...
        <div className="flex md:grid md:grid-cols-3 lg:grid-cols-6 gap-4 overflow-x-auto md:overflow-visible pb-4 md:pb-0">
          {features.map((feature, index) => (
            <div
              ...
              className="select-none flex-shrink-0 flex flex-col items-center pt-4 p-2 bg-white shadow-lg shadow-neutral-400 w-[250px] sm:w-[280px] md:w-full transition-colors duration-300"
            >
