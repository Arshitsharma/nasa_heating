...
export const Redtag = () => {
  return (
    <div className="bg-white py-10 px-4">
      {/* Title */}
      <h2 className="text-center text-3xl md:text-4xl font-bold">Red Tags</h2>

      {/* Paragraph */}
      <div className="text-center max-w-screen-lg mx-auto mt-6 text-lg md:text-xl">
      ...
      {/* List of Issues */}
      <div className="max-w-screen-lg mx-auto mt-8 md:mt-10">
        <ol className="list-decimal list-inside text-base md:text-lg grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
      ...
      <div className="bg-red-600 text-white text-center py-3 md:py-4 text-lg md:text-xl font-bold mt-6 md:mt-8 max-w-screen-lg mx-auto">
